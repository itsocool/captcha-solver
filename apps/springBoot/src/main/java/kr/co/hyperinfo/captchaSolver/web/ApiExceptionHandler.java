...
public class ApiExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> badRequest(CaptchaService.BadRequestException e) {
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(e.getMessage()));
	}

	@ExceptionHandler(CaptchaService.PredictionException.class)
	public ResponseEntity<ErrorResponse> predictionFailed(CaptchaService.PredictionException e) {
